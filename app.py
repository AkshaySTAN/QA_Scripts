...
@app.route('/Create_Upcoming_clubs_result')
async def Create_Upcoming_clubs_result():
    output = request.args.get('output')  # Get the output from the query parameter
    if output is None:
        output = "No output provided"
    return await render_template('Create_Upcoming_clubs_result.html', output=output)
